...
.\tools\build-release.ps1 -Version 4.3.1 -ReleaseNotes "<notes>" -CertificateThumbprint <thumbprint> -AllowUntrustedCertificate -ForceSmokeTest -Upload
...
Semantic versioning (`Major.Minor.Patch`). Current: **4.3.1**.
