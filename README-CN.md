...
[![Version](https://img.shields.io/badge/version-4.5.0-brightgreen)](https://download.matrixlabs.cn/tlah/windows/latest.json)
...
| `.\tools\verify-release.ps1 -Version 4.5.0 -AllowUntrustedAuthenticode` | 验证发布包 |
...
当前版本：**4.5.0**，语义化版本号 (`Major.Minor.Patch`)。
