...
[![Version](https://img.shields.io/badge/version-4.4.4-brightgreen)](https://download.matrixlabs.cn/tlah/windows/latest.json)
...
| `.\tools\verify-release.ps1 -Version 4.4.4 -AllowUntrustedAuthenticode` | 验证发布包 |
...
当前版本：**4.4.4**，语义化版本号 (`Major.Minor.Patch`)。
