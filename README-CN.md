...
[![Version](https://img.shields.io/badge/version-4.6.1-brightgreen)](https://download.matrixlabs.cn/tlah/windows/latest.json)
...
| `.\tools\verify-release.ps1 -Version 4.6.1 -AllowUntrustedAuthenticode` | 验证发布包 |
...
当前版本：**4.6.1**，语义化版本号 (`Major.Minor.Patch`)。
